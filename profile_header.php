<header class="main-header">
        ...
        <div class="header-top-right">
            <ul class="top-list">
                ...
                <div class="header-profile">
                    <a href="#" class="profile-link"><i class="fa-solid fa-user"></i>Hi, <?php if(isset($_SESSION['user_name']))echo $_SESSION['user_name'];?></a>
    ...
    <div class="header-mid">
        <div class="container-header-mid">
            <div class="header-logo"><a href="profile.php"><img src="./assets/img/header/logo.png" alt="logo" class="header-logo-img"></a></div>
            <div class="header-search">
                <form action="profile.php?page_layout=product_search" method="post" >
    ...
    <div class="header-bottom">
        ...
        <div class="nav">
            <ul class="nav1">
                <li class="nav1-item"><a href="profile.php" class="nav1-link"><i class="ti-home nav1-icon"></i>Home</a></li>
